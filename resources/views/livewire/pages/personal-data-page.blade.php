<main class="content flex-1">
    <div class="w-full relative mt-10">
        <h1 class="uppercase mb-10 text-5xl md:text-3xl">Политика обработки персональных данных</h1>
        <div class="page__content">
            <h2 class="mb-10 mt-10 text-4xl md:text-2xl">1. Общие положения</h2>
            <p class="mb-5">
                ...
                и меры по обеспечению безопасности персональных данных, предпринимаемые ТеплоКерамо (далее – Оператор).
            </p>
            <p class="mb-5">
            ...
            <p class="mb-5">
                ...
                <a href="https://teplokeramo.ru/">https://teplokeramo.ru/</a>
            </p>

            <h2 class="mb-10 mt-10 text-4xl md:text-2xl">2. Основные понятия, используемые в Политике</h2>
            <p class="mb-5">
            ...
            <p class="mb-5">
                ...
                данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a
                    href="https://teplokeramo.ru/">https://teplokeramo.ru/</a>;
            </p>
            <p class="mb-5">
            ...
            <p class="mb-5">
                ...
                определяемому Пользователю веб-сайта <a href="https://teplokeramo.ru/">https://teplokeramo.ru/</a>;
            </p>
            <p class="mb-5">
                2.9. Пользователь – любой посетитель веб-сайта <a href="https://teplokeramo.ru/">https://teplokeramo.ru/</a>;
            </p>
            <p class="mb-5">
            ...
            <h2 class="mb-10 mt-10 text-4xl md:text-2xl">
            ...
            <p class="mb-5">
                3.5. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов
            ...
            <p class="mb-5">
                ...
                <a href="mailto:hello@teplokeramo.ru">hello@teplokeramo.ru</a> с пометкой «Отказ от уведомлений о новых
                продуктах и услугах и специальных предложениях».
            </p>
            <p class="mb-5">
                4.3. Обезличенные данные Пользователей, собираемые с помощью сервисов интернетстатистики, служат для
            ...
            <p class="mb-5">
                ...
                Пользователем самостоятельно через специальные формы, расположенные на сайте <a
                    href="https://teplokeramo.ru/">https://teplokeramo.ru/</a>. Заполняя соответствующие формы и/или
            ...
            <p class="mb-5">
                ...
                самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a
                    href="mailto:hello@teplokeramo.ru">hello@teplokeramo.ru</a> с пометкой «Актуализация персональных
                данных».
            </p>
            <p class="mb-5">
                ...
                электронной почты на электронный адрес Оператора <a
                    href="mailto:hello@teplokeramo.ru">hello@teplokeramo.ru</a> с пометкой «Отзыв согласия на обработку
                персональных данных».
            </p>
            ...
            <h2 class="mb-10 mt-10 text-4xl md:text-2xl">8. Заключительные положения</h2>
            <p class="mb-5">
                ...
                персональных данных, обратившись к Оператору с помощью электронной почты <a
                    href="mailto:hello@teplokeramo.ru">hello@teplokeramo.ru</a>.
            </p>
            <p class="mb-5">
            ...
            <p class="mb-5">
                8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a
                    href="https://teplokeramo.ru/">https://teplokeramo.ru/</a>
            </p></div>
    </div>
</main>
